...
description: "شرح التعامل مع مكتبة توليد رموز الاستجابة السريعة qr codes في لغة go "
...
```
أو المزيد من التخصيص مثل التحكم في الألوان عبر  استخدام الوظائف المتاحة في المكتبه  
